...
import com.ast.MyBills.Utils.CustomAlertConfirmationInterface;
import com.ast.MyBills.Utils.CustomAlertDialog;
import com.ast.MyBills.Utils.IWebCallback;
import com.ast.MyBills.Utils.IWebIndexedCallback;
import com.ast.MyBills.Utils.IWebPaginationCallback;
...
public class AppConfig {
    private static com.ast.MyBills.AppConfig ourInstance;// = new AppConfig(null);
   ...
   public EditText etOTP;
    ...
    public ArrayList<String> lstImpDates;
  ...
  public   List<List<String>> lastYear = new ArrayList<List<String>>();
    ...
    public static void initInstance(Context _mContext) {
        if (ourInstance == null) {
            // Create the instance
            ourInstance = new com.ast.MyBills.AppConfig(_mContext);
        }
    }

    public static com.ast.MyBills.AppConfig getInstance() {
        return ourInstance;
    }
...
//                new BigDecimal(_distance).setScale(2, RoundingMode.HALF_UP).doubleValue()));
    ...
    public void navtoLogin() {
        ...
        if (mUser.isLoggedIn()) {
            ...
            try {
                Intent intent = new Intent(com.ast.MyBills.MyApplication.mContext,
                        IntroActivity.class);

                // set the new task and clear flags
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                com.ast.MyBills.MyApplication.mContext.startActivity(intent);

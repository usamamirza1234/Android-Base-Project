...
//        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        setAppLanguage(com.ast.MyBills.AppConfig.getInstance().loadDefLanguage());
    }
    ...
    public void setAppLanguage(String _lang) {
        ...
        if (_lang.equalsIgnoreCase(AppConstt.AppLang.LANG_UR)) {
            com.ast.MyBills.AppConfig.getInstance().saveDefLanguage(AppConstt.AppLang.LANG_UR);
            com.ast.MyBills.AppConfig.getInstance().isEnglishMode = false;
        } else {
            com.ast.MyBills.AppConfig.getInstance().saveDefLanguage(AppConstt.AppLang.LANG_EN);
            com.ast.MyBills.AppConfig.getInstance().isEnglishMode = true;
        }
        setLanguageSpecificFonts(com.ast.MyBills.AppConfig.getInstance().isEnglishMode);
